...
export function openStubModal(title: string, message: string, callbacks: StubModalCallbacks = {}): StubModalApi {
  ...
  css(panel, 'width:100%;max-width:420px;background:#15171c;border:1px solid #3a414d;border-radius:12px;padding:22px;font-family:Roboto, monospace;color:#dddddd;text-align:center;');
