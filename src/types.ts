 ...
 *   'rocket-h' — рождается из квадрата 2×2 (горизонтальная); сносит весь свой РЯД.
 *   'rocket-v' — рождается из квадрата 2×2 (вертикальная); сносит весь свой СТОЛБЕЦ.
 ...
 */
export type SpecialKind = 'bomb' | 'rocket-h' | 'rocket-v' | 'magnet';
