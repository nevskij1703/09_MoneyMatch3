...
export const balance: Balance = {
  ...
  // Старт — 5 типов объектов (арт T1..T5). Классике нужно больше цветов, чем цепочкам
  // (меньше случайных матчей, легче чистый старт). Прогрессия добавит тиры позже.
  tierCount: 5,
  board: {
    cols: 6,
    rows: 6,
  ...
  match: {
    ...
    baseTileValue: 5,  // T1-плитка = $10, T5-плитка = $160 (× tierValue 2^t)
  },
  economy: {
    startBalance: 0,
    startDiamonds: 50,
